...
const Forgot_password = () => {
    ...
    let handleFormValue = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            setloader(false)
            axios.post(`${process.env.REACT_APP_API_KEY}forgotPassword`, obj).then((res) => {
    ...
    let handle_reset_FormValue = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            axios.post(`${process.env.REACT_APP_API_KEY}resetPassword`, objdata).then((res) => {
        ...
        <div>
            ...
            <div className="breadcrumb-area">
                <div className="container">
                    ...
                    <div className="row ">
                        {/* col */}
                        <div className="col-12 col-lg-6 align-self-center" id='title-id'>
                            {/* breadcrumb */}
